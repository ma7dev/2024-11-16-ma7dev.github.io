...
# while in distill layout, toc needs to be entered manually
# toc:
#   - name: Equations
...
{::nomarkdown}
{% assign jupyter_path = "assets/jupyter/pandas.ipynb" | relative_url %}
{% capture notebook_exists %}{% file_exists assets/jupyter/pandas.ipynb %}{% endcapture %}
